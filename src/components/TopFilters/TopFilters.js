              ...
              <div className={styles.displayDate}>
                ...
                <div className={styles.wrapper}>
                  ...
                  <div className={styles.item}>
                    ...
                    {data.location.iso_country_code ? `, ${data.location.iso_country_code}` : ''}
                  </div>
                </div>
              </div>
                ...
                {displayCount && (
                  <div style={{ display: 'flex' }}>
                    <div className={styles.wrapper}>
                      ...
                      <div className={classnames(styles.item, styles.padding5)}>{data.occupancy.adults}</div>
                    </div>
                    <div className={styles.wrapper}>
                      <img src={kid} alt="" className={styles.img} />
                      <div className={classnames(styles.item, styles.padding5)}>{data.occupancy.children}</div>
                    </div>
                    <div className={styles.wrapper}>
                      <img src={bed} alt="" className={styles.img} />
                      <div className={classnames(styles.item, styles.padding5)}>{data.nights || 1}</div>
                    </div>
                  </div>
                )}
